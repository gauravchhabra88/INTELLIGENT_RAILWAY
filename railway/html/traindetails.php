  ...
  <tr>
    <td align="left" valign="top" class="headerbg"><table width="457" border="0" class="hdrcont" cellspacing="0" cellpadding="0">
      <tr>
		...
		<li><a href="aboutus1.html" title="About&nbsp;Us">About&nbsp;Us</a></li>
...
mysql_connect("$host", "$username", "$password")or die("cannot connect");
mysql_select_db("$db_name")or die("cannot select DB");
$sql="select * from trains where from1='$from' and to1 ='$to'";
$result=mysql_query($sql);
echo "<table border ='3'>";
echo "<tr>";
echo "<th>name</th><th>number</th><th>from</th><th>to</th><th>arrivaltime</th><th>duration</th>";
echo "</tr>";
...
$memid=$row['id'];
echo "<tr>";
echo "<td>","<a href=seat.php?memid=$memid>","<h3>",$row['name'],"</a></td><td><h3><font color=#ff0000>",$row['number'],"</h3></td><td><h3><font color=#ff0000>",$row['from1'],"</h3></font></td><td><h3><font color=#ff0000>",$row['to1'],"</h3></font></td><td><h3><font color=#ff0000>",$row['arrivaltime'],"
</h3></font></td><td><h3><font color=#ff0000>",$row['duration'],"</h3></font></td";
echo "</tr></h3></font>";
}
echo "</table>";
  ...
  <tr>
    <td height="66" align="center" valign="middle" class="footerbg"><table width="878" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="203" align="right" valign="top" class="copyright">Design by:Ankit Banka </td>
      </tr>
    </table></td>
  </tr>
</table>
